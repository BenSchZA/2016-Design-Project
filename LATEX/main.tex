...
\label{my-label}
\begin{tabular}{lllll}
                         & \textbf{Parking Bays} & \textbf{Allocated Bays} & \textbf{Disc Price} & \textbf{Cash Flow} \\
...
\textbf{}                &                       &                         &                     &                    \\
\textbf{Discs/bay}       & 2.8                   &                         &                     &                    \\
\textbf{Total Cash Flow} & 13670361.6            &                         &                     &                   
\end{tabular}
\end{table}
...
The costs of development, manufacturing and distribution through the above sources should be kept to a unit cost value of less than R400 per tag. This ensures the cost of a disc will cover the cost of production of the tag.
